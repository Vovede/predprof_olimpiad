               ...
               <layout class="QGridLayout" name="gridLayout_4" columnstretch="0,0,0">
                ...
                <item row="2" column="0">
                 <layout class="QVBoxLayout" name="verticalLayout_7">
                  ...
                  <item>
                   <widget class="QCheckBox" name="checkBoxDirectionWind">
                    <property name="font">
                     <font>
                      <pointsize>10</pointsize>
                     </font>
...
class Monitoringiop(QMainWindow):
    ...
    def get_time(self):
        # Время начала
        time_start = list(map(int, str(self.dateTimeEdit_2.dateTime())[23:len(str(self.dateTimeEdit_2.dateTime())) - 1].split(", ")))
        time_start.reverse()
        del time_start[0]

        # Время конца
        time_end = list(map(int, str(self.dateTimeEdit.dateTime())[23:len(str(self.dateTimeEdit.dateTime())) - 1].split(", ")))
        time_end.reverse()
        del time_end[0]
